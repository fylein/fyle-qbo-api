data = {
    ...
    "credit_card_purchase_item_and_account_based_payload": {
        ...
        "Line": [
            {
                "Description": "sravan.kumar@fyle.in - Concrete - 2023-04-19 - C/2023/04/R/3 -  - None/app/main/#/enterprise/view_expense/txT4kpMbHdLg8?org_id=or79Cob97KSh",
                "DetailType": "ItemBasedExpenseLineDetail",
                "Amount": 1.0,
                "ItemBasedExpenseLineDetail": {
                    "ItemRef": {"value": "3"},
            ...
            {
                "Description": "sravan.kumar@fyle.in - Food - 2023-04-19 - C/2023/04/R/2 -  - None/app/main/#/enterprise/view_expense/txoF0nqv6cG89?org_id=or79Cob97KSh",
                "DetailType": "AccountBasedExpenseLineDetail",
                "Amount": 10.0,
                "AccountBasedExpenseLineDetail": {
                    "AccountRef": {"value": "13"},
