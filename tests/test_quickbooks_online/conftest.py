...
def create_bill_item_and_account_based(db):
    ...
    expense_group = ExpenseGroup.objects.create(
        workspace_id=4,
        fund_source='CCC',
        description=json.loads('{"report_id": "rpcegBZcwUkHI", "fund_source": "CCC", "claim_number": "C/2023/04/R/2", "employee_email": "sravan.kumar@fyle.in"}'),
        employee_name='sravan k',    
    )
...
def create_credit_card_purchase_item_based(db):
    ...
    expense_group = ExpenseGroup.objects.create(
        workspace_id=3,
        fund_source='CCC',
        description=json.loads('{"report_id": "rpcegBZcwUkH", "fund_source": "CCC", "claim_number": "C/2023/04/R/3", "employee_email": "sravan.kumar@fyle.in"}'),
        employee_name='sravan k',    
    )
...
def create_credit_card_purchase_item_and_account_based(db):
    ...
    expense_group = ExpenseGroup.objects.create(
        workspace_id=3,
        fund_source='CCC',
        description=json.loads('{"report_id": "rpcegBZcwUkUi", "fund_source": "CCC", "claim_number": "C/2023/04/R/4", "employee_email": "sravan.kumar@fyle.in"}'),
        employee_name='sravan k',    
    )
...
def create_qbo_expense_item_based(db):
    ...
    expense_group = ExpenseGroup.objects.create(
        workspace_id=3,
        fund_source='CCC',
        description=json.loads('{"report_id": "rpcegBZcwpoP", "fund_source": "CCC", "claim_number": "C/2023/04/R/6", "employee_email": "sravan.kumar@fyle.in"}'),
        employee_name='sravan k',    
    )
...
def create_qbo_expense_item_and_account_based(db):
    ...
    expense_group = ExpenseGroup.objects.create(
        workspace_id=3,
        fund_source='CCC',
        description=json.loads('{"report_id": "rpcegBZcwUkpiL", "fund_source": "CCC", "claim_number": "C/2023/04/R/6", "employee_email": "sravan.kumar@fyle.in"}'),
        employee_name='sravan k',    
    )
...
def create_cheque_item_based(db):
    ...
    expense_group = ExpenseGroup.objects.create(
        workspace_id=3,
        fund_source='PERSONAL',
        description=json.loads('{"report_id": "rpcegBZciploL", "fund_source": "PERSONAL", "claim_number": "C/2023/04/R/7", "employee_email": "user9@fyleforgotham.in"}'),
        employee_name='Justin Glass',    
    )
...
def create_cheque_item_and_account_based(db):
    ...
    expense_group = ExpenseGroup.objects.create(
        workspace_id=3,
        fund_source='PERSONAL',
        description=json.loads('{"report_id": "rpcegBZcipIpkiLL", "fund_source": "PERSONAL", "claim_number": "C/2023/04/R/13", "employee_email": "user9@fyleforgotham.in"}'),
        employee_name='Justin Glass',    
    )
