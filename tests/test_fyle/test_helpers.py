...
def test_construct_expense_filter():
    ...
    expense_filter = ExpenseFilter(
        condition="employee_email", operator="in", values=["killua.z@fyle.in"], rank=1
    )
    constructed_expense_filter = construct_expense_filter(expense_filter)
    ...
    expense_filter = ExpenseFilter(
        condition="claim_number", operator="in", values=["ajdnwjnadw"], rank=1
    )
    constructed_expense_filter = construct_expense_filter(expense_filter)
    ...
    expense_filter = ExpenseFilter(
        condition="report_title", operator="iexact", values=["#17:  Dec 2022"], rank=1
    )
    constructed_expense_filter = construct_expense_filter(expense_filter)
    ...
    expense_filter = ExpenseFilter(
        condition="report_title", operator="icontains", values=["Dec 2022"], rank=1
    )
    constructed_expense_filter = construct_expense_filter(expense_filter)
    ...
    # spent-at-is-before
    expense_filter = ExpenseFilter(
        condition="spent_at", operator="lt", values=["2020-04-20 23:59:59+00"], rank=1
    )
    constructed_expense_filter = construct_expense_filter(expense_filter)
    ...
    expense_filter = ExpenseFilter(
        condition="spent_at", operator="lte", values=["2020-04-20 23:59:59+00"], rank=1
    )
    constructed_expense_filter = construct_expense_filter(expense_filter)
    ...
    expense_filter = ExpenseFilter(
        condition="Gon Number", operator="in", values=[102, 108], rank=1, is_custom=True
    )
    constructed_expense_filter = construct_expense_filter(expense_filter)
    ...
    expense_filter = ExpenseFilter(
        condition="Kratos", operator="in", values=["BOOK"], rank=1, is_custom=True
    )
    constructed_expense_filter = construct_expense_filter(expense_filter)
    ...
    expense_filter = ExpenseFilter(
        condition="Kratos", operator="isnull", values=["False"], rank=1, is_custom=True
    )
    constructed_expense_filter = construct_expense_filter(expense_filter)
    ...
    expense_filter = ExpenseFilter(
        condition="Kratos", operator="isnull", values=["True"], rank=1, is_custom=True
    )
    constructed_expense_filter = construct_expense_filter(expense_filter)
...
def test_multiple_construct_expense_filter():
    ...
    expense_filters = [
        ...
        ExpenseFilter(
            condition="report_title", operator="icontains", values=["Dec 2022"], rank=2
        ),
    ]
