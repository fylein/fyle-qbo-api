data = {
    'export_settings': {
        ...
        'general_mappings': {
            ...
            'default_ccc_vendor': {'name': 'Arun', 'id': '87'},
            'qbo_expense_account': {'name': 'Auto', 'id': '95'},
            'default_debit_card_account': {'id': '', 'name': ''},
        },
    },
    ...
    'response': {
        ...
        'general_mappings': {
            'accounts_payable': {'name': 'Accumulated Depreciation', 'id': '3'},
            'qbo_expense_account': {'name': 'Auto', 'id': '95'},
            'bank_account': {'name': '', 'id': ''},
            'default_ccc_account': {'name': '', 'id': ''},
            'default_debit_card_account': {'name': '', 'id': ''},
            'default_ccc_vendor': {'name': 'Arun', 'id': '87'},
        },
        'workspace_id': 9,
    },
