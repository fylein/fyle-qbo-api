...
def create_or_update_general_settings(general_settings_payload: Dict, workspace_id):
    ...
    assert_valid(
        'category_sync_version' in general_settings_payload and general_settings_payload[
            'category_sync_version'], 'category_sync_version is blank')
    ...
    general_settings, _ = WorkspaceGeneralSettings.objects.update_or_create(
        ...
        defaults={
            ...
            'category_sync_version': general_settings_payload['category_sync_version'],
