...
class ExportSettingsTrigger:
    ...
    def post_save_workspace_general_settings(self):
        ...
        if (self.__workspace_general_settings['reimbursable_expenses_object'] == 'JOURNAL ENTRY'
                or self.__workspace_general_settings['corporate_credit_card_expenses_object'] == 'JOURNAL ENTRY') and\
