...
def create_bill(expense_group, task_log_id, last_export: bool):
    ...
    try:
        qbo_credentials = QBOCredential.active_qbo_credentials(expense_group.workspace_id)
...
def async_sync_accounts(workspace_id):
    qbo_credentials: QBOCredential = QBOCredential.active_qbo_credentials(workspace_id)
