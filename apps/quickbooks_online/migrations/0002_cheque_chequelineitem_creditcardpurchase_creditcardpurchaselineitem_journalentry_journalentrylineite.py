    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank_account_id', models.CharField(help_text='QBO Bank account id', max_length=255)),
                ...
                ('currency', models.CharField(help_text='Cheque Currency', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(help_text='CreditCardPurchase Currency', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(help_text='JournalEntry Currency', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('debit_account_id', models.CharField(help_text='QBO Debit account id', max_length=255)),
                ...
                ('entity_id', models.CharField(help_text='QBO entity id', max_length=255)),
                ('entity_type', models.CharField(help_text='QBO Entity Type ( Vendor / Employee )', max_length=255)),
                ('customer_id', models.CharField(help_text='QBO customer id', max_length=255, null=True)),
                ('department_id', models.CharField(help_text='QBO department id', max_length=255, null=True)),
                ('posting_type', models.CharField(help_text='QBO posting type', max_length=255, null=True)),
                ('amount', models.FloatField(help_text='JournalEntry amount')),
                ('description', models.CharField(help_text='QBO JournalEntry lineitem description', max_length=255, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='Created at')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Updated at')),
                ('expense', models.OneToOneField(help_text='Reference to Expense', on_delete=django.db.models.deletion.PROTECT, to='fyle.Expense')),
                ('journal_entry', models.ForeignKey(help_text='Reference to JournalEntry', on_delete=django.db.models.deletion.PROTECT, to='quickbooks_online.JournalEntry')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(help_text='QBO credit card purchase lineitem description', max_length=255, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='Created at')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Updated at')),
                ('credit_card_purchase', models.ForeignKey(help_text='Reference to credit card purchase', on_delete=django.db.models.deletion.PROTECT, to='quickbooks_online.CreditCardPurchase')),
                ('expense', models.OneToOneField(help_text='Reference to Expense', on_delete=django.db.models.deletion.PROTECT, to='fyle.Expense')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(help_text='QBO cheque lineitem description', max_length=255, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='Created at')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Updated at')),
                ('cheque', models.ForeignKey(help_text='Reference to cheque', on_delete=django.db.models.deletion.PROTECT, to='quickbooks_online.Cheque')),
                ('expense', models.OneToOneField(help_text='Reference to Expense', on_delete=django.db.models.deletion.PROTECT, to='fyle.Expense')),
            ],
        ),
    ]
