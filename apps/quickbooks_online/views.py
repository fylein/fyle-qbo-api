...
class VendorView(generics.ListCreateAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        """
        try:
            qbo_credentials = QBOCredential.objects.get(workspace_id=kwargs['workspace_id'], is_expired=False)
...
class PreferencesView(generics.RetrieveAPIView):
    ...
    def post(self, request, **kwargs):
        try:
            qbo_credentials = QBOCredential.objects.filter(workspace=kwargs['workspace_id'], is_expired=False).first()
            qbo_connector = QBOConnector(qbo_credentials, workspace_id=kwargs['workspace_id'])
    ...
    def get(self, request, *args, **kwargs):
        try:
            qbo_credentials = QBOCredential.objects.get(workspace=kwargs['workspace_id'], refresh_token__isnull=False, is_expired=False)
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if workspace.destination_synced_at is None or time_interval.days > 0:
                quickbooks_credentials = QBOCredential.objects.get(workspace_id=kwargs['workspace_id'], is_expired=False)
