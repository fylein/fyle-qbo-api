...
target_func = ['apps.quickbooks_online.tasks.create_bill', 'apps.quickbooks_online.tasks.create_cheque', 'apps.quickbooks_online.tasks.create_qbo_expense', 'apps.quickbooks_online.tasks.create_credit_card_purchase', 'apps.quickbooks_online.tasks.create_journal_entry']
