...
class Migration(migrations.Migration):
    ...
    dependencies = [('workspaces', '0003_auto_20200506_0739'), ('fyle', '0003_auto_20200626_1401')]
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=100), default=apps.fyle.models.get_default_expense_group_fields, help_text='list of fields reimbursable expense grouped by', size=None),
                ),
                (
                    'corporate_credit_card_expense_group_fields',
                    django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=100), default=apps.fyle.models.get_default_expense_group_fields, help_text='list of fields ccc expenses grouped by', size=None),
                ),
