...
# Run this in sql
# select * from django_q_schedule where func = 'apps.mappings.tasks.auto_import_and_map_fyle_fields';
# --rows should be 0
# If not check the workspace_id and delete the row
# delete from django_q_schedule where func = 'apps.mappings.tasks.auto_import_and_map_fyle_fields' and args = 'workspace_id';
