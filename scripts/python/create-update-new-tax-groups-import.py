...
# Run this in sql
# select * from django_q_schedule where func = 'apps.mappings.tasks.auto_create_tax_codes_mappings';
# --rows should be 0
# If not check the workspace_id and delete the row
# delete from django_q_schedule where func = 'apps.mappings.tasks.auto_create_tax_codes_mappings' and args = 'workspace_id';
